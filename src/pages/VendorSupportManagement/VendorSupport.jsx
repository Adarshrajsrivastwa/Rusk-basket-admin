...
const TicketManagementSystem = ({
  ...
  // Auto open new ticket modal if prop is true
  useEffect(() => {
    if (autoOpenNewTicket) {
  ...
  const [tickets, setTickets] = useState([
    {
      ...
      description: "Unable to process payments through gateway",
      category: "Technical",
      priority: "High",
      status: "Open",
      createdBy: "TechStore (Vendor)",
    ...
    {
      id: "TKT-002",
      title: "Product Listing Not Visible",
      description: "My products are not showing on the marketplace",
      category: "Product",
      priority: "Medium",
      status: "In Progress",
      createdBy: "Fashion Hub (Vendor)",
    ...
    },
    {
      ...
      description: "Wrong commission deducted from my sales",
      category: "Billing",
      priority: "High",
      status: "In Progress",
      createdBy: "BookWorld (Vendor)",
    ...
    {
      id: "TKT-005",
      title: "How to Update Store Banner",
      description: "Need help updating my store banner image",
      category: "General",
      priority: "Low",
      status: "Resolved",
      createdBy: "John Doe (User)",
      assignedTo: "Support Team A",
      createdAt: "2025-10-18",
      updatedAt: "2025-10-19",
      messages: 4,
      feedback: { rating: 5, comment: "Quick resolution!" },
    },
    {
      id: "TKT-006",
      title: "Shipping Address Update Issue",
      description: "Cannot change shipping address in my account",
      category: "Account",
      priority: "Medium",
      status: "Open",
      createdBy: "Sarah Wilson (User)",
      assignedTo: "Unassigned",
    ...
    },
    {
      ...
      description: "Order cancelled but refund not processed",
      category: "Billing",
      priority: "High",
      status: "In Progress",
      createdBy: "Mike Brown (User)",
    ...
    },
    {
      ...
      description: "Customer cannot track their order status",
      category: "Product",
      priority: "Low",
      status: "Resolved",
      createdBy: "QuickShip (Vendor)",
      assignedTo: "Support Team B",
      createdAt: "2025-10-17",
      updatedAt: "2025-10-18",
      messages: 6,
      feedback: { rating: 4, comment: "Good support" },
    },
    {
      id: "TKT-010",
      title: "Bulk Product Import Error",
      description: "CSV import failing with validation errors",
      category: "Technical",
      priority: "High",
      status: "Escalated",
      createdBy: "MegaMart (Vendor)",
      assignedTo: "Super Admin",
      createdAt: "2025-10-20",
      updatedAt: "2025-10-22",
      messages: 15,
  ...
  const supportTeams = ["Support Team A", "Support Team B", "Support Team C"];
  ...
  const totalPages = Math.ceil(filterTickets().length / itemsPerPage);
  ...
  const handleCreateTicket = () => {
    ...
    const ticket = {
      ...
      ...newTicket,
      status: "Open",
      createdBy: `Current ${newTicket.userType}`,
      assignedTo: "Unassigned",
  ...
  const handleSubmitFeedback = () => {
    if (selectedTicket && feedback.rating > 0) {
      setTickets(
        tickets.map((t) =>
          t.id === selectedTicket.id ? { ...t, feedback: { ...feedback } } : t
        )
      );
      ...
      <div className="min-h-screen  p-6">
        <div className="max-w-8xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            ...
            <div className="bg-white rounded-lsm shadow-sm p-4 border-l-4 border-orange-500">
              <div className="flex items-center justify-between">
                <div>
          ...
          <div className="bg-white rounded-sm shadow-sm mb-6">
            ...
            <div className="p-4">
              <div className="flex gap-4">
                ...
                <button className="bg-orange-500 text-white px-6 py-2 rounded hover:bg-orange-600 transition-colors font-medium">
                  Search
                </button>
              </div>
            </div>
          ...
          {totalPages > 1 && (
            <div className="flex justify-end items-center gap-6 mt-8 max-w-[95%] mx-auto">
              ...
              <button
                ...
                className="bg-[#FF7B1D] text-white px-10 py-3 text-sm font-medium rounded hover:bg-orange-600 transition-colors disabled:cursor-not-allowed"
              >
                Back
              </button>
              ...
              <button
                ...
                className="bg-[#247606] text-white px-10 py-3 text-sm font-medium rounded hover:bg-green-800 transition-colors  disabled:cursor-not-allowed"
              >
                Next
              </button>
            </div>
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setNewTicket({ ...newTicket, userType: e.target.value })
                    }
        ...
        {showAssignModal && selectedTicket && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg max-w-md w-full">
              <div className="p-6 border-b border-gray-200 bg-orange-500 text-white rounded-t-lg">
              ...
              <div className="p-6">
                ...
                <div className="space-y-2">
                  {supportTeams.map((team) => (
                    <button
                      key={team}
                      onClick={() => handleAssignTicket(team)}
                      className="w-full px-4 py-3 border-2 border-orange-500 text-orange-600 rounded hover:bg-orange-500 hover:text-white transition-colors font-medium"
                    >
                      {team}
                    </button>
                  ))}
            ...
            <div className="bg-white rounded-lg max-w-md w-full">
              ...
              <div className="p-6 space-y-4">
                <p className="text-gray-700">
                  ...
                  has been resolved. Please provide your feedback:
                </p>
